    ...
    <html lang="en">
      ...
      >
        <main className="relative grid min-h-screen grid-cols-2">
          ...
          <div className="relative flex max-h-screen flex-col overflow-x-hidden overflow-y-scroll bg-[url(../assets/bg-stars.svg)] scrollbar-thin scrollbar-thumb-purple-600">
            {children}
          </div>
        </main>
      </body>
